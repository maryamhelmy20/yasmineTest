...
<section class="mb-4">
    <div class="container text-left">
        <div class="row">
            ...
            <div class="col-lg-6 mt-lg-0 mt-4" id="cart_summary">
...
<div class="card rounded border-0 shadow-sm">
                    ...
                    <div>
                        ...
                        <div class="card-body text-center" style="border: 1px solid #fff7f7;
                                border-radius: 32px;
                                margin: 16px;
                                box-shadow: -1px 2px 1px -2px #a1909073;
                                        ...
                                        <div class="select-payment-method">
                                                ...
                                                <div>
                                                    <div class="payment">
                                                        ...
                                                        <div class="frame-container">
                                                            <div class="light-parent">
                                                                <div class="light">
                                                                    <div class="master-radio">
                                                                        <input
                                                                            class="form-check-input master-radio-checkbox"
                                                                            required type="radio"
                                                                            name="payment_option"
                                                                            value="paymob_card_payment" id="cardpayment"
                                                                            checked>
                                                                        <img
                                                                            src="{{ static_asset('assets/img/cards/credit-cardd.png') }}">
                                                                ...
                                                                <div class="payment-parent">
                                                                    <img class="payment-icon" alt=""
                                                                        src="{{ static_asset('assets/img/cards/visa.svg') }}" />
                                                                    <img class="payment-icon" alt=""
                                                                        src="{{ static_asset('assets/img/cards/mastercard.svg') }}" />
                                                                    <img class="payment-icon" alt=""
                                                                        src="{{ static_asset('assets/img/cards/mezza.png') }}"
                                                                        style="border: 1px solid #f0f2f3;
                                                                                                                                                                      border-radius: 10px;" />
                                                                </div>
                                                            </div>
                                                            <div class="pay-securely-with-your-bank-ac-wrapper">
                                                                <div class="pay-securely-with">
                                                                   {{translate('Pay securely with your Bank Account using Visa or
                                                                    Mastercard')}} 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <label class="aiz-megabox d-block mb-3">
                                                                <input value="paymob_valu_payment"
                                                                    class="online_payment" type="radio"
                                                                    name="payment_option" checked>
                                                                <span class="d-block aiz-megabox-elem p-3">
                                                                    <img src="{{ static_asset('assets/img/cards/valu.png') }}"
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <label class="aiz-megabox d-block mb-3">
                                                                <input value="paymob_bank_installment_payment"
                                                                    class="online_payment" type="radio"
                                                                    name="payment_option" checked>
                                                                <span class="d-block aiz-megabox-elem p-3">
                                                                    <img src="{{ static_asset('assets/img/cards/bankinstallment.jpg') }}"
                                                                        class="img-fluid mb-2">
                                                                    <span class="d-block text-center">
                                                                        <span class="d-block fw-600 fs-15">{{
                                                                            translate('Bank Installment') }}</span>
                                                                    </span>
                                                                </span>
                                                            </label>
                                                        </div>
                                                                ...
                                                                <div class="light">
                                                                    <div class="master-radio">
                                                                        <input
                                                                            ...
                                                                            required="" type="radio"
                                                                            name="payment_option"
                                                                            value="paymob_mobile_wallet_payment"
                                                                            id="ewallet" checked="">
                                                                        <img
                                                                            src="{{ static_asset('assets/img/cards/wallet.png') }}">

                                                                        <div class="radio">
                                                                            <label class="radio form-check-label"
                                                                                for="ewallet" data-bs-toggle="collapse"
                                                                                data-target="#ewallet"
                                                                                aria-controls="ewallet">E-wallet</label>
                                                                        </div>
                                                                    </div>

                                                                </div>
                                                                <div class="payment-parent">
                                                                    <img class="payment-iconn" alt=""
                                                                        src="{{ static_asset('assets/img/cards/vodafone.png') }}" />
                                                                    <img class="payment-iconn" alt=""
                                                                        src="{{ static_asset('assets/img/cards/orange.png') }}" />
                                                                    <img class="payment-iconn" alt=""
                                                                        src="{{ static_asset('assets/img/cards/etisalat.png') }}" />
                                                                    <img class="payment-iconn" alt=""
                                                                        src="{{ static_asset('assets/img/cards/phonecache.png') }}" />
                                                                    <img class="payment-iconn" alt=""
                                                                        src="{{ static_asset('assets/img/cards/qaheracache.png') }}" />
                                                                    <img class="payment-iconn" alt=""
                                                                        src="{{ static_asset('assets/img/cards/cib.png') }}" />
                                                                    <img class="payment-iconn" alt=""
                                                                        src="{{ static_asset('assets/img/cards/alahly.png') }}" />
                                                                </div>
                                                                <span class="d-block text-center">
                                                                    <input type="number" class="form-control"
                                                                        name="phone_number" placeholder="Mobile Number"
                                                                        style="position: relative !important;z-index: 1;opacity: 1;margin-top: 10px;border-radius: 50px;" required>
                                                                </span>
                                                            </div>
                                                            <div class="pay-securely-with-your-bank-ac-wrapper">
                                                                <div class="pay-securely-with">
                                                                   {{translate(' You will be redirected to PayPal website to complete
                                                                    your
                                                                    order securely.')}}
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <label class="aiz-megabox d-block mb-3">
                                                                ...
                                                                <span class="d-block aiz-megabox-elem p-3">
                                                                    ...
                                                                    <span class="d-block text-center">
                                                                        <span class="d-block fw-600 fs-15">{{
                                                                            translate('ToyyibPay') }}</span>
                                                                    </span>
                                                                </span>
                                                            </label>
                                                        </div>
                                                        @endif
                                                        @if (addon_is_activated('paytm') && get_setting('myfatoorah') ==
                                                        1)
                                                        <div class="col-6 col-md-4">
                                                            <label class="aiz-megabox d-block mb-3">
                                                                ...
                                                                <div class="light">
                                                                    <div class="master-radio">
                                                                        <input
                                                                            ...
                                                                            required="" type="radio"
                                                                            name="payment_option"
                                                                            value="cash_on_delivery" id="cod"
                                                                            checked="">
                                                                        <img
                                                                            src="{{ static_asset('assets/img/cards/money.png') }}">

                                                                        <div class="radio">
                                                                            <label class="radio form-check-label"
                                                                                for="cod" data-bs-toggle="collapse"
                                                                                data-target="#cod"
                                                                                aria-controls="cod">{{translate('Cash On
                                                                                Delivery')}}</label>
                                                                            <img
                                                                                src="{{ static_asset('assets/img/cards/question.png') }}">
                                                        ...
                                                        <div id="manual_payment_info_{{ $method->id }}" class="d-none">
                                                            ...
                                                            <ul>
                                                                @foreach (json_decode($method->bank_info) as $key =>
                                                                $info)
                                            ...
                                            <div class="d-none mb-3 rounded border bg-white p-3 text-left">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label">{{ translate('Photo')
                                                        }}</label>
                                                    <div class="col-md-9">
                                            ...
                                            <div class="py-4 text-center">
                                                <div class="h6 mb-3">
                                                    <span class="opacity-80">{{ translate('Your wallet balance :')
                                                        }}</span>
                                                    <span class="fw-600">{{ single_price(Auth::user()->balance)
                                                        }}</span>
                                                </div>
