...
<form class="form-default" role="form" action="{{ route('addresses.storee') }}" method="POST">
@if ($errors->any())
...
<div class="alert alert-danger"> <ul> @foreach ($errors->all() as $error)
    ...
    </div> @endif @csrf <div class="modal-body"> <div class="p-3">
    ...
    <div class="row">
       ...
       <div class="col-md-10">
           <input type="text" class="form-control mb-3" placeholder="{{ translate('Contact Name')}}" name="name" maxlength="80" value="{{ old('name') }}" required>
       </div>
    </div>
    <!--@endif-->
...
<div class="col-md-2">
    ...
    <div class="col-md-10">
        <div class="mb-3">
        <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select
        your country') }}" name="country_id" required>
...
<div class="col-md-2">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <input type="number" class="form-control mb-3" placeholder="{{ translate('+880')}}" name="phone" value=""
                required>
        </div>
    </div>
