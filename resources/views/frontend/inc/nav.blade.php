                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0 dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg py-0">
                                    <div class="p-3 bg-light border-bottom">
                                         ...
                                         class="mb-0">{{ translate('Notifications') }}</h6>
                                    </div>
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex justify-content-start ml-0">
                    <a class="d-block py-20px  ml-0 d-flex justify-content-start" href="{{ route('home') }}">
                        @php
                            $header_logo = get_setting('header_logo');
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40" style="width: 80px;">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40" style="width: 80px;">
                        @endif
               ...
               <div class="m-1 mt-3  ">
                  ...
                  <h5 class="font-weight-bold  m-0"  >{{ env('APP_NAME') }} </h5>
                 <p class=" text-secondary  font-weight-ligh m-0 ml-1 "  > Feel New Beauty Experience</p>
               </div>
