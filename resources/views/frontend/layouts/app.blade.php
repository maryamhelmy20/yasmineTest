...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ static_asset('assets/css/payment.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets/css/global.css') }}">
    ...
    radioButtons.forEach(function (radioButton) {
        radioButton.addEventListener('change', function () {
            // Get the payment logo section
            var paymentLogo = document.querySelector('.payment-parent');
            
            // Toggle the display property based on whether the current radio button is checked
            paymentLogo.style.display = this.id === 'ewallet' && this.checked ? 'flex' : 'none';
        });
    });
    </script>
    <script>
    ...
    radioButtons.forEach(function (radioButton) {
        radioButton.addEventListener('change', function () {
            ...
            // Toggle the display property based on whether the current radio button is checked
            paymentLogo.style.display = this.id === 'cardpayment' && this.checked ? 'flex' : 'none';
        });
    });
    </script>
