...
@section('content')
    ...
    <!--                <ul class="list-unstyled mb-0 row gutters-5 ">-->
    <!--                    @foreach ($featured_categories as $key => $category)-->
    <!--                        <li class="minw-0 col-4 col-md mt-3" style="min-width:112px">-->
    <!--                            <a href="{{ route('products.category', $category->slug) }}"-->
    <!--                                class="d-block rounded bg-white p-2 text-reset shadow-sm">-->
    <!--                                <img src="{{ static_asset('assets/img/placeholder.jpg') }}"-->
    <!--                                    data-src="{{ uploaded_asset($category->banner) }}"-->
    ...
    <!--                                    height="78"-->
    <!--                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">-->
    <!--                                <div class="text-truncate fs-12 fw-600 mt-2 opacity-70" style="text-align: center">-->
    <!--                                    {{ $category->getTranslation('name') }}</div>-->
    <!--                            </a>-->
    <!--                        </li>-->
    <!--                    @endforeach-->
  ...
  @if (count($featured_categories) > 0)
     ...
     <div class="container">
                    <div class="px-2 py-4 px-md-4 py-md-3 shadow-sm rounded">
                        <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="13" data-xl-items="5"
                            data-lg-items="2" data-md-items="2" data-sm-items="2" data-xs-items="2" data-arrows='true'>
                            @foreach ($featured_categories as $key => $category)
                            <li class="minw-0 col-12 col-md-12 mt-3" data-arrows='true' style="min-width:112px">
                                <a href="{{ route('products.category', $category->slug) }}"
                                    class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                    <img src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                        data-src="{{ uploaded_asset($category->banner) }}"
...
@endif
    ...
    @if (get_setting('home_banner1_images') != null)
        <div class="mb-4  mobile-img-auto-height">
            <div class="container">
                            ...
                            <div class="mb-3 mb-lg-0">
                                <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}"
                                    ...
                                    <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                      ...
                                      alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload w-100  mobile-img-auto-height " style="    object-fit:fill; ">
                                </a>
                            </div>
                        </div>
                    @endforeach
