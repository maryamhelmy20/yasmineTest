                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" onclick="guestlogin()" name="guest_login" value="1"
                                    class="btn btn-primary btn-block fw-600" style="display: inline-grid;background: indianred; transition: background 0.3s ease;" onmouseover="this.style.background='#004b35'" onmouseout="this.style.background='indianred'"><i class="las la-user-secret la-2x"></i> {{ translate('Login as guest') }}</button>
                            </div>
                        </form>
...
@section('script')
    <script type="text/javascript">
        ...
        function guestlogin() {
                ...
                $.ajax({
                    url: '/users/login/cart',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        guest_login: 1  // Add the guest_login parameter
                    },
