            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('product Lable')}} </label>
                            <div class="col-md-6">
                                <input type="text" lang="en" min="0" value="{{ $product->product_Lable}}" step="0.01" placeholder="{{ translate('product Lable') }}" name="product_Lable" class="form-control" value="{{ $product->product_Lable}}" >
                            </div>
                       
                        </div>
                <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                                {{translate('Review Point comment')}}
                            </label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{ $product->review_point }}" step="1" placeholder="{{ translate('1') }}" name="review_point" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                                {{translate('Review Point image')}}
                            </label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{ $product->review_point_image }}" step="1" placeholder="{{ translate('1') }}" name="review_point_image" class="form-control">
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-6 col-from-label">{{translate('Show Stock With Text and Quantity')}}</label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="stock_visibility_state" value="textqty" @if($product->stock_visibility_state == 'textqty') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
