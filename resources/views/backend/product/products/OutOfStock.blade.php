...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{translate('Out Of Stock')}}</h1>
        </div>
...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('Out Of Stock') }}</h5>
            </div>
...
@if($qty == 0)
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <strong>{{translate('Num of Sale')}}:</strong>  <a href="{{ route('all_orders.id', $product->id )}}">
                         {{ $product->num_of_sale }} {{translate('times')}}
