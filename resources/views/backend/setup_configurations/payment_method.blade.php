                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_API_KEY" value="{{  env('PAYMOB_API_KEY') }}" placeholder="{{ translate('Paymob Api Key') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_INTEGRATION_ID" value="{{  env('PAYMOB_CARD_INTEGRATION_ID') }}" placeholder="{{ translate('Paymob Card Integration Id') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_IFRAME_ID" value="{{  env('PAYMOB_CARD_IFRAME_ID') }}" placeholder="{{ translate('Paymob Card Iframe Id') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Card Valu Integration Id')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_VALU_INTEGRATION_ID" value="{{  env('PAYMOB_CARD_VALU_INTEGRATION_ID') }}" placeholder="{{ translate('Paymob Card Valu Integration Id') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Card Valu Iframe Id')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_VALU_IFRAME_ID" value="{{  env('PAYMOB_CARD_VALU_IFRAME_ID') }}" placeholder="{{ translate('Paymob Card Valu Iframe Id') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_BANK_INSTALLMENT_INTEGRATION_ID" value="{{  env('PAYMOB_BANK_INSTALLMENT_INTEGRATION_ID') }}" placeholder="{{ translate('Paymob Bank Installment Integration ID') }}" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_BANK_INSTALLMENT_IFRAME_ID" value="{{  env('PAYMOB_BANK_INSTALLMENT_IFRAME_ID') }}" placeholder="{{ translate('Paymob Bank Installment Integration ID') }}" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_MOBILE_WALLET_INTEGRATION_ID" value="{{  env('PAYMOB_MOBILE_WALLET_INTEGRATION_ID') }}" placeholder="{{ translate('Paymob Mobile Wallet Integration ID') }}" required>
                            </div>
                        </div>
