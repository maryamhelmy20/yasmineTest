...
<div class="card">
    ...
    <div class="col-lg ml-auto">
            ...
            <div class="col-lg">
                <div class="form-group mb-0">
                    <input type="text" class="form-control" id="name_search" name="name_search"@isset($name_search) value="{{ $name_search }}" @endisset placeholder="{{ translate('Name') }}">
                </div>
            </div>
            <div class="col-lg">
                <div class="form-group mb-0">
                    <input type="text" class="form-control" id="email_search" name="  email_search "@isset($email_search) value="{{ $email_search }}" @endisset placeholder="{{ translate('Email') }}">
                </div>
            </div>
