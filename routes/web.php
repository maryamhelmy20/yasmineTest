...
Route::controller(LoginController::class)->group(function () {
    ...
    Route::get('/insta/login', 'redirectToInstagramProvider')->name('insta.login');;
    Route::get('/social-login/instagram/callback', 'instagramProviderCallback')->name('insta.login.callback');

    Route::get('/guestCheckout', 'Checkoutasguest')->name('guestCheckout.index');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::controller(AddressController::class)->group(function () {
        ...
        Route::post('/addresses/store', 'store')->name('addresses.storee');
